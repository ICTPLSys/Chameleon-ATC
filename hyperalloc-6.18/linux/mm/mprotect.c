	       ...
	       unsigned long start, unsigned long end, vm_flags_t newflags)
{
	...
	/* Restore before VMA splitting/merging or changing its permissions.
	 * No PTL is held here; native protection code handles the result. */
	error = chameleon_shadow_restore_range(mm, start, end);
	if (error)
		return error;
