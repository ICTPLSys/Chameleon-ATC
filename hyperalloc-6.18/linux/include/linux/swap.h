...
#define SWP_PTE_MARKER     (MAX_SWAPFILES + SWP_HWPOISON_NUM + \
			    SWP_MIGRATION_NUM + SWP_DEVICE_NUM + SWP_CHAMELEON_NUM)

#ifdef CONFIG_CHAMELEON
#define SWP_CHAMELEON_NUM 2
#define SWP_CHAMELEON_SHADOW (MAX_SWAPFILES + SWP_HWPOISON_NUM + \
			     SWP_MIGRATION_NUM + SWP_DEVICE_NUM)
#define SWP_CHAMELEON_RECLAIMED (SWP_CHAMELEON_SHADOW + 1)
#else
#define SWP_CHAMELEON_NUM 0
#endif
...
#define MAX_SWAPFILES \
	...
	SWP_PTE_MARKER_NUM - SWP_CHAMELEON_NUM)
