...
static inline bool is_chameleon_shadow_entry(swp_entry_t entry)
{
#ifdef CONFIG_CHAMELEON
	return swp_type(entry) == SWP_CHAMELEON_SHADOW;
#else
	return false;
#endif
}

static inline bool is_chameleon_reclaimed_entry(swp_entry_t entry)
{
#ifdef CONFIG_CHAMELEON
	return swp_type(entry) == SWP_CHAMELEON_RECLAIMED;
#else
	return false;
#endif
}
...
#ifdef CONFIG_CHAMELEON
static inline swp_entry_t make_chameleon_reclaimed_entry(unsigned long token)
{
	return swp_entry(SWP_CHAMELEON_RECLAIMED, token);
}
#endif

#ifdef CONFIG_CHAMELEON
static inline swp_entry_t make_chameleon_shadow_entry(unsigned long pfn)
{
	return swp_entry(SWP_CHAMELEON_SHADOW, pfn);
}
#endif
...
static inline bool is_pfn_swap_entry(swp_entry_t entry)
{
	...
	return is_migration_entry(entry) || is_device_private_entry(entry) ||
	       ...
	       is_chameleon_shadow_entry(entry);
}
