...
struct lruvec {
	...
	/* Independent index, protected by the existing lru_lock. */
	struct list_head chameleon_lists[2][10];
	struct list_head *chameleon_cursor[2][10];
	unsigned long chameleon_count[2][10];
#endif
